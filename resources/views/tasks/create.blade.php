...
<div class="max-w-2xl mx-auto px-4 sm:px-0">
    <h2 class="text-2xl font-bold text-white mb-6">Nieuwe taak aanmaken</h2>
        ...
        <form action="{{ route('tasks.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" 
                       ...
                       placeholder="Bijv: Opdrachten maken..."
                       required>
                @error('title')
            ...
            <div class="mb-6">
                ...
                <textarea name="description" 
                          ...
                          placeholder="Extra details over de taak...">{{ old('description') }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                @enderror
            </div>
